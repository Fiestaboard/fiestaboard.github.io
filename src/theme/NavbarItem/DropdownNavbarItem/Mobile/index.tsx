/**
 * Swizzled DropdownNavbarItem/Mobile component.
 *
 * Only change from the original: the dropdown starts expanded (initialState: false)
 * so that mobile sidebar users immediately see all documentation sections
